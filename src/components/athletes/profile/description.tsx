      ...
      <div className="space-y-2">
        ...
        <div className="flex space-x-8">
          ...
          <div className="flex-col flex">
            ...
            <span className="font-extralight text-2xl">170.18cm/5ft 7in</span>
          </div>
          <div className="flex-col flex">
        ...
        <div className="flex space-x-8">
          ...
          <div className="flex-col flex">
            ...
            <span className="font-extralight text-2xl">Argentine Spanish</span>
          </div>
        </div>
        <div className="flex space-x-8">
          <div className="flex-col flex">
            <span className="font-bold text-lg">Citizenships</span>
            <span className="font-extralight text-xl">Argentine, British</span>
          </div>
        </div>
        <div className="flex flex-col text-sm">
          ...
          <span className="font-bold">
            Affiliated Teams & Organization, Camps and Coaching Clinics, Awards
            & Recognitions
          </span>
        </div>
      </div>
